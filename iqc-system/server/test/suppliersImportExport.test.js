// Integration tests — Suppliers Excel export/import: ผู้ดูแลจัดซื้อ (Y/N per purchasing user) + diff-aware
// update/skip logic (S128k) via HTTP (node --test)
...
async function buildImportXlsx(assigneeHeaders, rows) {
  ...
  ws.addRow(['รหัสผู้ผลิต', 'ชื่อผู้ผลิต *', 'อีเมล', 'เบอร์โทร', 'หมายเหตุ', ...assigneeHeaders]);
